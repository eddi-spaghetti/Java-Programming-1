/* Chapter 3 Exercise 3.7 (Financial application: monetary units)
...
public class ComputeChange {
    public static void main(String[] args) {
            ...
            // Display results, showing only nonzero denomiations
            System.out.println("Your amount " + amount + " consists of");
            
            //Check if units are singlular for single word usage for display
